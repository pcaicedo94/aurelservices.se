            ...
            <div className="col-lg-8">
              <div className="blog-details-desc">
                <div className="article-image">
                  <img
                    src="/images/blog-details/blog-details1.jpg"
                    alt="image"
                  />
                </div>
                ...
                <div className="article-content">
                  ...
                  <ul className="wp-block-gallery columns-3">
                    <li className="blocks-gallery-item">
                      <figure>
                        <img
                          src="/images/blog-details/blog-gallery1.jpg"
                          alt="image"
                        />
                      </figure>
                    </li>
                    ...
                    <li className="blocks-gallery-item">
                      <figure>
                        <img
                          src="/images/blog-details/blog-gallery2.jpg"
                          alt="image"
                        />
                      </figure>
                    </li>
                    ...
                    <li className="blocks-gallery-item">
                      <figure>
                        <img
                          src="/images/blog-details/blog-gallery3.jpg"
                          alt="image"
                        />
                      </figure>
                    </li>
